...
public class EgovMultipartResolver extends CommonsMultipartResolver {
	...
	}//MultiValueMap<String,MultipartFile> mpFiles, Map<String,String[]> mpParams
	/*
	 * 
	 * MultipartParsingResult를 생성하기 위하여 기존에 HashMap등의 형태로 인자를 전달했다면, 
	 * MultiValueMap의 형태로 인자를 전달하여 인스턴스를 생성하여 주시기 바랍니다. MultiValueMap은 Map 인터페이스의 구현클래스입니다. 
	 * 따라서 HashMap등의 인스턴스를 Map 형태로 선언하여 전달했을 경우, MultiValueMap으로 캐스팅하여 전달하는 형태로 해결할 수 있습니다.
	 * 
	 */
